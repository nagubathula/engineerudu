...
export default function Navigation() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 flex flex-row items-center justify-between px-8 py-6 max-w-7xl mx-auto w-full">
      ...
      <div className="hidden md:flex flex-row items-center space-x-8 bg-background/20 backdrop-blur-md px-6 py-2 rounded-full border border-white/10">
        ...
        <Link href="/projects" className="text-sm text-muted-foreground hover:text-white transition-colors">Projects</Link>
      </div>
